...
const EMAIL_VALUE_REGEX =
  /[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}/gi; // case-insensitive via 'i'
  ...
  return (
    <div className="min-h-screen p-10 font-sans">
      ...
      <textarea
        ...
        rows={10}
        className="w-full mb-4 rounded bg-black text-white outline-none p-[2rem] placeholder:text-gray-400"
      />

      {/* EMAILS TO REMOVE */}
      <label className="block mb-2 font-medium">
        Paste Emails to remove (can be a list or any multi‑column text containing
        emails):
      </label>
      <textarea
        ...
        rows={8}
        className="w-full mb-6 rounded bg-black text-white outline-none p-[2rem] placeholder:text-gray-400"
      />
